...
![tsp_img.png](\img\posts\combinatorial1\tsp_img.png)
...
\
And it is now that the real difficulties begin to appear, because the naive solution's complexity is $O(n!)$ (that's 77 years to solve an instance with 20 cities with a frequency of 1GHz). 
\
...
\
So instead of searching an exact solution, we will try to find an approximate one in a much shorter timespan. I am talking about solving a instance with 400 cities in less than a minute. Yes, that's quite the improvement !
...
![png](\img\posts\combinatorial1\output_11_1.png)
...
With this algorithm, we can find a solution in one second, with a mean score of 1530 over 20 solutions. The best score was 1333 and the worst was 1815. Running the algorithm multiple times is a way to find a better quality solution.
...
![png](\img\posts\combinatorial1\output_14_1.png)
...
![png](\img\posts\combinatorial1\output_17_1.png)
...
![png](\img\posts\combinatorial1\output_20_1.png)
...
![png](\img\posts\combinatorial1\output_24_1.png)
